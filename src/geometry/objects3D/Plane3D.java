...
public class Plane3D {
    ...
    /**
     * Конструктор плоскости по вектору нормали и точке
     * @param vector Вектор нормали
     * @param point Точка
     */
    ...
    /**
     * Конструктор плоскости по 3 точкам
    ...
    /**
     * @return D из уравнения плоскости вида Ax+By+Cz+D=0 (A,B,C соответствуют 3 координатам вектора нормали)
     */
    public double getD() {
    ...
    /**
     * @param p Точка
     * @return Расстояние от точки до текущей плоскости
     */
    ...
    /**
     * @param l Прямая
     * @return Возможная точка пересечения прямой и текущей плоскости
     */
    ...
    /**
     * @param p Плоскость
     * @return Возможнпя прямая пересечения данной и текущей плоскости
     */
